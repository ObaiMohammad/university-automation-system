...
public class CourseStudentServices {
	...
	public static Integer getGrade (int courseId, int studentId) {
	...
	public static void setGradeOneLine (int teacherId,int courseId, int studentId, int studentGrade) {
		for (Teacher teacher :CourseTeacherServices.findTeacherByCourses(courseId)) {
			...
			else System.out.println("not a teacher");
		}
	}

	public static void setGradeOneLineSimplified (int courseId, int studentId, int studentGrade) {
